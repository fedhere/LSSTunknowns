...
class LSPMmetric(BaseMetric):
    def __init__(self,metricName='LSPMmetric', populationfile = 'population_nside32.p', f='g', surveyduration=10, snr_lim=5., sigma_threshold=1, m5Col='fiveSigmaDepth', mjdCol='observationStartMJD', filterCol='filter', seeingCol='seeingFwhmGeom', dataout=False,**kwargs):
